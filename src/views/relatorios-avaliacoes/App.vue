					...
					<div class="row">
						...
						<div class="col-xl-3 col-lg-3 col-md-3 col-sm-5" id="coluna">
							<div class="nota-media-comportamental">
								<div class="card mb-4" id="card-grande">
									<div class="card-body">
										<h1 class="card-title" id="titulo-nota-comportamental">{{relatorio.notaMediaAvaliacaoComportamental}}</h1>
						...
						<div class="col-xl-2 col-lg-2 col-md-2 col-sm-4" id="coluna">
							<div class="nota-media-praticas-ageis">
								<div class="card mb-4" id="card-pequeno">
									<div class="card-body">
										<h1 class="card-title" id="titulo-nota-praticas-ageis">{{relatorio.notaMediaAvaliacaoPraticasAgeis}}</h1>
...
export default {
  ...
  methods: {
    ...
    getRelatorio() {
      http.get('relatorio-avaliacao/formacao=' + this.parametrosUrl.formacao + '/turma=' + this.parametrosUrl.turma + '/escopo=' + this.parametrosUrl.escopo)
