            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6" id="coluna">
              <div id="media-hora">
                <div class="card mb-4" id="card-grande">
                  <div class="card-body">
                    <h1 class="card-title" id="titulo-media-hora">
                      {{ relatorio.mediaDeHorasDosParticipantes }}
                    </h1>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6" id="coluna">
              <div id="maior-hora">
                <div
                  class="card mb-4"
                  id="card-grande"
                  @mouseover="mostrarFuncionarioMaiorQntHoras = true"
                  @mouseleave="mostrarFuncionarioMaiorQntHoras = false"
                >
                  <div class="card-body">
                    <h1 class="card-title" id="titulo-maior-hora">
                      {{ relatorio.maiorQuantidadeDeHorasDosParticipantes }}
                    </h1>
                    <p class="card-text">
                      Maior quantidade de horas por participante.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6" id="coluna">
              <div id="menor-hora">
                <div
                  class="card mb-4"
                  id="card-grande"
                  @mouseover="mostrarFuncionarioMenorQntHoras = true"
                  @mouseleave="mostrarFuncionarioMenorQntHoras = false"
                >
                  <div class="card-body">
                    <h1 class="card-title" id="titulo-menor-hora">
                      {{ relatorio.menorQuantidadeDeHorasDosParticipantes }}
                    </h1>
                    <p class="card-text">
                      Menor quantidade de horas por participante.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6" id="coluna">
              <div id="ultimo-registro">
                <div class="card mb-4" id="card-grande">
                  <div class="card-body">
                    <h1 class="card-title" id="titulo-ultimo-registro">
                      {{ relatorio.dataUltimoRegistro }}
                    </h1>
                    <p class="card-text" id="texto-ultimo-registro">
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6" id="coluna">
              <div id="funcionario-maior-hora">
                <div
                  class="card mb-4"
                  id="card-grande"
                  v-show="mostrarFuncionarioMaiorQntHoras"
                >
                  <div class="card-body">
                    <h6 class="card-title" id="nome-funcionario">
                      {{ relatorio.nomeFuncionarioComMaiorQuantidadeHoras }}
                    </h6>
                    <p class="card-text" id="cargo">
                      {{ relatorio.cargoFuncionarioComMaiorQuantidadeHoras }}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6" id="coluna">
              <div id="funcionario-menor-hora">
                <div
                  class="card mb-4"
                  id="card-grande"
                  v-show="mostrarFuncionarioMenorQntHoras"
                >
                  <div class="card-body">
                    <h6 class="card-title" id="nome-funcionario">
                      {{ relatorio.nomeFuncionarioComMenorQuantidadeHoras }}
                    </h6>
                    <p class="card-text" id="cargo">
                      {{ relatorio.cargoFuncionarioComMenorQuantidadeHoras }}
                    </p>
                  </div>
                </div>
              </div>
